...
function DevPage({ searchResult }) {
  return (
    <div className="overflow-y-auto">
      {
        searchResult.length && searchResult.map((result, resultIdx) => (
              ...
              <div className="flex">
                ...
                <div className="info">
                  ...
                  <div className="flex">
                    ...
                    <p className="text-base ml-1 text-gray-600">{result && result.locationName ? result.locationName : 'No location supplied'}</p>
                  </div>
                </div>
              </div>
              <div className="right">
                <div className="flex pb-3">
                  ...
                  <p className="text-base text-gray-600">{result.remote === true ? 'Remote' : 'Onsite'}</p>
                </div>
                <div className="flex">
